...
public class GoogleTraceHandler {
    ...
    public void buildTraceFileNames(){
        ...
        TRACE_FILENAMES.add("D:\\paperWork\\clusterdata2011\\task_event_process_firstDay\\event.csv");
        Usage_FILENAMES.add("D:\\paperWork\\clusterdata2011\\task_usage_process_firstDay\\usage.csv");
