...
//    public static final String MACHINE_FILENAME = "F:/paperData/clusterdata2011/machine_events/part-00000-of-00001.csv.gz";
    ...
    public static final int VMS = 5;   //虚拟机数目
    ...
    public static final double SUBMISSIONDELAY = 1.0;   //cloudlet延迟提时间
    public static boolean ENABLE_FILTER_USAGE = false;  //启用过滤数据
    ...
    public static final int GOOGLE_EVENT_DAYS_FILE = 0;   //谷歌前十天taskEvent和usageEvent所到的文件下标,默认172
