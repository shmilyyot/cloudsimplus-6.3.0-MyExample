...
public class Constant {
     ...
     * google真实任务数据源地址
     * */
    public static final String TASK_EVENTS_PATH = "F:\\paperData\\clusterdata2011\\task_events";
    public static final String TASK_USAGE_PATH = "F:\\paperData\\clusterdata2011\\task_usage";
    ...
    public static final String MACHINE_FILENAME = "F:\\paperData\\clusterdata2011\\machine_events\\part-00000-of-00001.csv";
    ...
    public static final boolean USING_EXISTANCE_CLOULETS = true;    //使用外部cloulet的id，不使用自己生成的
    /**
